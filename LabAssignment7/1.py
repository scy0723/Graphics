...
def key_callback(window, key, scancode, action, mods):
    ...
    if action==glfw.PRESS or action==glfw.REPEAT:
        ...
        elif key==glfw.KEY_A: #light_red
            lightColor=(1.,0.,0.,1.)
        elif key==glfw.KEY_S: #light_green
            lightColor=(0.,1.,0.,1.)
        elif key==glfw.KEY_D: #light_blue
            lightColor=(0.,0.,1.,1.)
        elif key==glfw.KEY_F: #light_white
            lightColor=(1.,1.,1.,1.)
            
        elif key==glfw.KEY_Z: #object_red
            objectColor = (1.,0.,0.,1.)
        elif key==glfw.KEY_X: #object_green
            objectColor = (0.,1.,0.,1.)
        elif key==glfw.KEY_C: #object_blue
            objectColor = (0.,0.,1.,1.)
        elif key==glfw.KEY_V: #object_white
            objectColor = (1.,1.,1.,1.)
